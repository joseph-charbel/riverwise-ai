...
def _build_debug_preview(request: AiDebugRequest) -> AiDebugPreviewResponse:
        ...
        if request.language == "nepali":
                translation_messages = build_translate_messages(
                        "<LLM output from adaptation pipeline>"
                )
        ...
        return AiDebugPreviewResponse(
                ...
                translation_system_prompt=(
                        debug_translation_messages[0].content
                        if debug_translation_messages
                        else ""
                ),
...
def ai_debug_options():
        ...
        bands = [
                ...
                for r in ConfigManager().grade_rules().rules
        ]
